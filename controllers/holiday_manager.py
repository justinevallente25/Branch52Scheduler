# controllers/holiday_manager.py
...
class HolidayManager:
    ...
    def save(self):
        ...
        with open(self.file, "w") as f:
            ...
            json.dump(self.custom_holidays, f, indent=4)

    # ==========================
    # GET PHILIPPINE HOLIDAYS
    # ==========================

    def get_ph_holidays(self, year):

        return holidays.PH(years=year)
    ...
    def get_all_holidays(self, year):
        ...
        for date, name in ph.items():
            ...
            result.append({"date": str(date), "name": name})
